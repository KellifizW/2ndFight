...
@export var st_lp_hitstun_frames: int = 18      # 18 幀 = 0.30 秒
...
@export var st_mk_hitstun_frames: int = 39      # 39 幀 = 0.65 秒
...
@export var st_hk_hitstun_frames: int = 45      # 45 幀 = 0.75 秒
...
@export var cr_lk_hitstun_frames: int = 24      # 24 幀 = 0.40 秒
