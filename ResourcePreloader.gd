...
const VFX_BLOCK: PackedScene = preload("res://vfx_blk.tscn")
const FIREBALL_DAV: PackedScene = preload("res://DAV_fireball.tscn")
const FIREBALL_DEN: PackedScene = preload("res://DEN_fireball.tscn")
